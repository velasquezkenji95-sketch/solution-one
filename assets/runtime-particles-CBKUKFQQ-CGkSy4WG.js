...
`,this.emitterShape.positionsTexture),o=r.addVariable(`uCurrentVelocity`,n+`
...
`,this.emitterShape.directionsTexture),s=r.addVariable(`uCurrentEmissionRate`,`
...
`,function(e){let t=new Float32Array(4*e*e);for(let n=0;n<e*e;n++)t[4*n]=0,t[4*n+1]=0,t[4*n+2]=0,t[4*n+3]=0;let n=new S(t,e,e,g,C);return n.needsUpdate=!0,n}(this.emitterShape.textureSize));r.setVariableDependencies(a,[a,o,s]),r.setVariableDependencies(o,[a,o,s]),r.setVariableDependencies(s,[a,o,s]);let c=function({size:e}){let t=new Float32Array(4*e*e);for(let n=0;n<e*e;n++)t[4*n]=n,t[4*n+1]=0,t[4*n+2]=0,t[4*n+3]=0;let n=new S(t,e,e,g,C);return n.needsUpdate=!0,n}({size:this.emitterShape.textureSize}),l={uOriginalPosition:{value:this.emitterShape.positionsTexture},uWorldOffset:{value:new i(0,0,0)},uWorldQuaternion:{value:new x(0,0,0,1)},uTime:{value:0},uFPSRatio:{value:1},uMaxLifeTime:{value:e.life},uEmitterSize:{value:new i(Number(this.shared.getVariable(e.shape.size[0],[this.uuid,`particles`,`shape_size_0`])),Number(this.shared.getVariable(e.shape.size[1],[this.uuid,`particles`,`shape_size_1`])),Number(this.shared.getVariable(e.shape.size[2],[this.uuid,`particles`,`shape_size_2`])))},particleSize:{value:0}};a.material.uniforms=l;let u=this.getDirectionFromVariable(e.direction);this.directionAxis=this.getDirectionAxis(u),this.worldGravity.set(0,Number(this.shared.getVariable(this.system.data.gravity,[this.uuid,`particles`,`gravity`]))/100,0),this.noiseStrength=Number(this.shared.getVariable(e.noiseStrength,[this.uuid,`particles`,`noiseStrength`])),this.noiseScale=Number(this.shared.getVariable(e.noiseScale,[this.uuid,`particles`,`noiseScale`]));let d=e.colliderEntityId&&this.system.getColliderData(e.colliderEntityId),f={uOriginalPosition:{value:this.emitterShape.positionsTexture},uDirections:{value:this.emitterShape.directionsTexture},uDirectionsAxis:{value:this.directionAxis},uWorldQuaternion:{value:new x(0,0,0,1)},uColliderPos:{value:new i(0,0,0)},uColliderSize:{value:new i(0,0,0)},uForceIntensity:{value:d?d.forceIntensity:0},uForceDamping:{value:d?d.forceDambing:0},uColliderQuaternion:{value:new x(0,0,0,1)},uColliderQuaternionInvert:{value:new x(0,0,0,1)},particleSize:{value:0},uGravity:{value:this.worldGravity},uNoiseStrength:{value:this.noiseStrength},uNoiseScale:{value:this.noiseScale},uNoiseSeed:{value:e.noiseSeed},uRandomMassFactor:{value:e.randomMass},uBounce:{value:e.collisionBounce},uSpeed:{value:Number(this.shared.getVariable(e.speed,[this.uuid,`particles`,`speed`]))/10}};o.material.uniforms=f;let p={uIndex:{value:c},uTime:{value:0},uLastIndexEmitted:{value:0},uParticlesToEmit:{value:0}};s.material.uniforms=p;let m=[Number(this.shared.getVariable(e.shape.size[0],[this.uuid,`particles`,`shape_size_0`])),Number(this.shared.getVariable(e.shape.size[1],[this.uuid,`particles`,`shape_size_1`])),Number(this.shared.getVariable(e.shape.size[2],[this.uuid,`particles`,`shape_size_2`]))],h={...U(this.system.data).shape,size:m};this.emitterShape.applyToShader(a.material.uniforms,h),r.init(),this.gpuCompute=r,this.positionSimRT=a,this.velocitySimRT=o,this.emissionRateSimRT=s,this.material.uniforms.uPosition.value=r.getCurrentRenderTarget(a)?.texture,this.rootObject=this.createPrimaryEmitter(this.emitterShape.textureSize),this.add(this.rootObject),this.material.needsUpdate=!0}getDirectionFromVariable(e){return[Number(this.shared.getVariable(e[0],[this.uuid,`particles`,`direction_x`])),Number(this.shared.getVariable(e[1],[this.uuid,`particles`,`direction_y`])),Number(this.shared.getVariable(e[2],[this.uuid,`particles`,`direction_z`]))]}updateSimulationDefinition(e){if(this.simFeaturesDefinition.USE_COLLIDER=!1,this.simFeaturesDefinition.USE_ATTRACTOR=!1,this.simFeaturesDefinition.USE_VORTEX=!1,this.simFeaturesDefinition.USE_SPHERE_COLLIDER=!1,this.simFeaturesDefinition.USE_BOX_COLLIDER=!1,this.simFeaturesDefinition.USE_FORCE_LOCAL_SPACE=!1,this.simFeaturesDefinition.USE_NORMALS=!1,this.simFeaturesDefinition.USE_CURL_NOISE=!1,this.simFeaturesDefinition.USE_SIMPLEX_NOISE=!1,this.simFeaturesDefinition.USE_FBM_NOISE=!1,e.colliderEntityId&&this.system.colliderEntities.length>0){let t=this.system.getColliderData(e.colliderEntityId);switch(t?.forceType){case`attractor`:this.simFeaturesDefinition.USE_ATTRACTOR=!0;break;case`collider`:this.simFeaturesDefinition.USE_COLLIDER=!0;break;case`vortex`:this.simFeaturesDefinition.USE_VORTEX=!0}let n=t?.colliderType;n===`sphere`&&(this.simFeaturesDefinition.USE_SPHERE_COLLIDER=!0),n===`box`&&(this.simFeaturesDefinition.USE_BOX_COLLIDER=!0),t?.forceRange===`helper`&&(this.simFeaturesDefinition.USE_FORCE_LOCAL_SPACE=!0)}e.directionMode===`normals`&&(this.simFeaturesDefinition.USE_NORMALS=!0),e.noiseType===`curl`&&(this.simFeaturesDefinition.USE_CURL_NOISE=!0),e.noiseType===`simplex`&&(this.simFeaturesDefinition.USE_SIMPLEX_NOISE=!0),e.noiseType===`fbm`&&(this.simFeaturesDefinition.USE_FBM_NOISE=!0);let t=``;for(let[e,n]of Object.entries(this.simFeaturesDefinition))n&&(t+=`#define ${e}\n`);return t}createShape(e,t){this.emitterShape&&this.emitterShape.dispose();let n=new i(Number(this.shared.getVariable(e.size[0],[this.uuid,`particles`,`shape_size_0`])),Number(this.shared.getVariable(e.size[1],[this.uuid,`particles`,`shape_size_1`])),Number(this.shared.getVariable(e.size[2],[this.uuid,`particles`,`shape_size_2`])));if(e.type===`MeshEmitterShape`){let r=null;return this.system.context.scene.traverseEntity(t=>{t.uuid===e.fromMeshId&&(r=t)}),r?new H(n,t,e.type,r):new H(n,t,`SphereEmitterShape`)}return new H(n,t,e.type)}createPrimaryEmitter(e){let t=e*e,n=new h(new a(1,1,1),this.material,t);return this.updateGeometryAttributes(n,e),this.material.needsUpdate=!0,n.onBeforeRender=()=>{this.applyWorldSpace()},n}getMaxParticlesAmount({birthRatePerSecond:e,particleMaxLifeTime:t,loopDuration:n=0}){return Math.ceil(e*(t+n))}dispose(){!this.gpuCompute||(this.rootObject?.parent?.remove(this.rootObject),this.gpuCompute.dispose(),this.material.nodeMaterialDispose(),this.emitterShape?.dispose())}GoEmitSomeParticles(e,t){let n=e-this.lastEmitTime,r=1/t;if(n>=r){let t=Math.max(1,Math.floor(n/r));return this.lastEmitTime=e,this.emittedParticlesAmount+t>this.particlesAmount&&(this.emittedParticlesAmount=0),this.emittedParticlesAmount+=t,t}return 0}checkIfAllParticlesAreDead(){return this.lastEmitTime+this.system.data.life+1<this.globalTime}reset(){this.hasBeenReset=!0,this.lastEmitTime=0,this.emittedParticlesAmount=0,this.gpuCompute&&this.init(U(this.system.data))}startEmitting(e){this.isEmitting=!0,this.hasBeenReset=!1,this.lastEmitTime=e}stopEmitting(){this.isEmitting=!1}},G=class extends k{constructor(e,t,n){super(e,t),this.type=`ParticleSystem`,this.isParticleSystem=!0,this.geometry=new T,this.actualTime=0,this.currentLoopTime=0,this.started=!1,this.stopped=!1,this.timeoutId=void 0,this.isFrozen=!1,this.isIdle=!0,this.emitter=null,this.colliderEntities=[],this.renderer=null,this.isPreWarm=!1,this._hasOnAfterRenderBeenCalled=!1,this.onAfterRender=e=>{e.warmupInFlight||this._hasOnAfterRenderBeenCalled||(this._hasOnAfterRenderBeenCalled=!0,this.init(e))},this.context=n,this.data={...t,...U(t)},this.geometry.setAttribute(`position`,new s([],3)),this.material=new c({colorWrite:!1}),this.frustumCulled=!1}init(e){this.renderer=e,this.emitter=new W(e,this),this.add(this.emitter),this.updateParticleState(this.data)}update(e){if(!this.isReady||!this.started||this.isFrozen||this.isIdle)return;this.actualTime+=e,this.stopped||(this.currentLoopTime+=e);let t=this.data.emitTimeCycle===`one_time`;if((this.data.emitTimeCycle===`loop`||t)&&this.currentLoopTime>1e3*this.data.emitTimeDuration&&(this.stopped||(this.stop(),t||this.start(1e3*this.data.emitTimeDelay))),this.emitter&&this.started){let t=this.actualTime/1e3;this.emitter.update(t,e)}this.scale.set(1,1,1),this.updateMatrix()}isReady(){return!!this.emitter}hasCollider(e){return this.colliderEntities.some(t=>t.identity===e)}getColliderData(e){let t=this.colliderEntities.find(t=>t.identity===e);return t?t.data:null}updateByPatchedOp(e,t,n){super.updateByPatchedOp(e,t,n),O(e.path,[`renderMaterial`])&&this.updateParticleState({renderMaterial:{...this.data.renderMaterial,...E.drop(e,1).props}}),O(e.path,[`shape`])&&this.updateParticleState({shape:{...this.data.shape,...E.drop(e,1).props}})}updateState(e,t){super.updateState(e,t),this.updateParticleState(e)}updateParticleState(e){if(this.emitter){if(e.colliderEntityId!==void 0&&e.colliderEntityId!==null){let t=this.context.scene.find(e.colliderEntityId);this.colliderEntities=t?[t]:[]}e.colliderEntityId===null&&(this.colliderEntities=[]),this.emitter.updateState(e),e.emitTimeCycle&&this.started&&this.start()}}updateFromColliderEntity(e){!this.emitter||(this.emitter.updateForceFieldParameters(e),this.stop(),this.start())}start(e=0){this.currentLoopTime=0,e?this.timeoutId=window.setTimeout(()=>{this.start(0)},e):(this.started=!0,this.stopped=!1,this.isFrozen=!1,this.emitter?.startEmitting(this.actualTime/1e3),this._requestRender())}froze(){this.isFrozen=!0,this._requestRender()}unFroze(){this.isFrozen=!1,this._requestRender()}stop(){this.stopped=!0,this.currentLoopTime=0,this.emitter?.stopEmitting(),clearTimeout(this.timeoutId),this._requestRender()}reset(){this.started=!1,this.stopped=!1,this.emitter?.reset(),this._requestRender()}_requestRender(){this.context.shared.requestRender()}wakeUp(){this.isIdle=!1}sleep(){this.isIdle=!0,this.reset()}},K=class{constructor(e,t,n,r){this.data=e,this.page=t,this.shared=n,this.condition=r,this.delay=0,this.emission=e.emission,e.delay!==void 0&&(this.delay=e.delay),this.particleSystem=this.page.scene.find(this.data.emitterObjectId)}toggleEmitting(){this.particleSystem.started&&!this.particleSystem.stopped?this.stop(this.delay):this.start(this.delay)}toggleFroze(){this.particleSystem.started&&!this.particleSystem.isFrozen?this.freeze(this.delay):this.unFreeze(this.delay)}start(e=0){e?this.delayTimerId=window.setTimeout(()=>{this.start(0),this.clearDelay()},e):this.particleSystem.start()}stop(e=0){e?this.delayTimerId=window.setTimeout(()=>{this.stop(0),this.clearDelay()},e):this.particleSystem.stop()}freeze(e=0){e?this.delayTimerId=window.setTimeout(()=>{this.freeze(0),this.clearDelay()},e):this.particleSystem.froze()}unFreeze(e=0){e?this.delayTimerId=window.setTimeout(()=>{this.unFreeze(0),this.clearDelay()},e):this.particleSystem.unFroze()}reset(e=0){e?this.delayTimerId=window.setTimeout(()=>{this.reset(0),this.clearDelay()},e):this.particleSystem.reset()}reverseFromCurrent(){switch(this.emission){case`emitToggle`:this.toggleEmitting();break;case`pauseToggle`:this.toggleFroze()}}dispatchBasic(){if(!1===j(this.shared,this.condition)||!this.particleSystem)return!1;switch(this.emission){case`start`:this.start(this.delay);break;case`emitToggle`:this.toggleEmitting();break;case`pause`:this.freeze(this.delay);break;case`pauseToggle`:this.toggleFroze();break;case`stop`:this.stop(this.delay);break;case`reset`:this.reset(this.delay)}}dispatchConditional(){if(!1===j(this.shared,this.condition)||!this.particleSystem)return!1;switch(this.emission){case`start`:this.start(this.delay);break;case`stop`:this.stop(this.delay);break;case`reset`:this.reset(this.delay)}}dispatchGameControl(e){if(!1===j(this.shared,this.condition)||!this.particleSystem)return!1;e===`start`?this.start(this.delay):this.stop(this.delay)}dispose(){!this.particleSystem||(this.particleSystem.reset(),this.clearDelay())}clearDelay(){this.delayTimerId&&(clearTimeout(this.delayTimerId),delete this.delayTimerId)}};t(`Particle`,(e,t,n)=>new G(e,t,n)),A(`Particles`,({data:e,page:t,shared:n,actionCondition:r})=>new K(e,t,n,r)),e(`particles`);